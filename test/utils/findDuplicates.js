...
import { findDuplicates } from '../../dist/utils.js'
...
describe('findDuplicates', () => {
  ...
  describe('when array has no duplicates', () => {
    ...
    it('works with single element', () => {
      const result = findDuplicates([42])
      expect(result).to.have.length(0)
    })
  })
  ...
  describe('complex scenarios', () => {
    it('handles array with many duplicates', () => {
      const result = findDuplicates([1, 1, 2, 2, 2, 3, 3, 3, 3])
      expect(result).to.have.length(6)
      expect(result).to.have.members([1, 2, 2, 3, 3, 3])
    })

    it('maintains original order of duplicates', () => {
      const result = findDuplicates([5, 1, 3, 1, 2, 5, 3, 2])
